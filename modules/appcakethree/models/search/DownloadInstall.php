...
use app\modules\appcakethree\models\DownloadInstall as DownloadInstallModel;
...
class DownloadInstall extends DownloadInstallModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['position', 'idfa', 'ip', 'device', 'country','cake_channel'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->select('download_install.app_id,d.app_name,camp_id,country,category,position,idfa,count(*) as count')->groupBy('app_id')->orderBy("count desc");
