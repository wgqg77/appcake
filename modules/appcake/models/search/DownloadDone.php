...
use app\modules\appcake\models\DownloadDone as DownloadDoneModel;
...
class DownloadDone extends DownloadDoneModel
{
    ...
    public function search($params)
    {
        ...
        $query->select('download_done.app_id,d.app_name,camp_id,country,category,position,idfa,count(*) as count')->groupBy('app_id,country')->orderBy("count desc");
