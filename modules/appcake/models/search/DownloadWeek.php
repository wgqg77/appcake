...
use app\modules\appcake\models\DownloadWeek as DownloadWeekModel;
...
//            ->andFilterWhere(['like', 'device', $this->device])
        ...
        $query->select('download_week.app_id,d.app_name,camp_id,country,category,position,idfa,count(*) as count')->groupBy('app_id,country')->orderBy("count desc");
